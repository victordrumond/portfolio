...
$(document).ready(() => {
    ...
    new TypeIt("#typed-content-en", {
        ...
        .type("<br>", {delay: 1000})
        .type("Here you will find my projects and also some info about me.<br>", {delay: 800})
        .type("<br>", {delay: 500})
        .pause(200)
    ...
    new TypeIt("#typed-content-pt", {
        ...
        .type("<br>", {delay: 1000})
        .type("Aqui você encontrará os meus projetos e algumas informações sobre mim.<br>", {delay: 800})
        .type("<br>", {delay: 500})
        .pause(200)
